...
//DISABLED_DUP: int32_t  osTvType        = 0;       // SDK expects s32
//DISABLED_DUP: int32_t  osRomType       = 0;       // SDK expects s32
void* osRomBase       = nullptr; // SDK expects void* (64-bit pointer on Android)
//DISABLED_DUP: int32_t  osResetType     = 0;       // SDK expects s32
int32_t  osCicId         = 0;       // SDK expects s32
//DISABLED_DUP: int32_t  osVersion       = 0;       // SDK expects s32
//DISABLED_DUP: uint32_t osMemSize       = 0;
