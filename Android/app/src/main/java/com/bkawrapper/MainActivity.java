...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NativeBridge.nativeInit(this); // safe unified initialization
    ...
    public LinearLayout getMenuOverlay() { return menuOverlay; } // expose safely for JNI
    ...
    private void showOTRProgress() { runOnUiThread(() -> progressOverlay.setVisibility(View.VISIBLE)); }
    private void hideOTRProgress() { runOnUiThread(() -> progressOverlay.setVisibility(View.GONE)); }
