...
void func_80387E00(s32 arg0){
    ...
    func_803262E4(this);
    __spawnQueue_add_2((GenFunction_2)func_80387D18, reinterpret_cast(intptr_t, marker), 0x1E);
}
...
void chCroctus_activateNextCroctus(ActorMarker *caller, enum asset_e text_id, s32 arg2){
    ...
    if(text_id == VER_SELECT(ASSET_C86_DIALOG_CROCTUS_FIRST_SUCCESS, 0x9C9, 0, 0)){
        ...
        timedFunc_set_1(1.1f, (GenFunction_1)func_80387E00, reinterpret_cast(intptr_t, bgs_D_803907B8[this->actorTypeSpecificField]));
        ...
        __spawnQueue_add_2((GenFunction_2) func_80387D18, reinterpret_cast(intptr_t, this->marker), 0x46);
    }
    else{
        ...
        if ((this->state != CHCROCTUS_STATE_5_FED) && (this->state != CHCROCTUS_STATE_6_DESPAWN)) {
            ...
            if (this->actorTypeSpecificField == 1) {
                ...
                if (this->actorTypeSpecificField == 5) {
                    timedFunc_set_1(0.9f, (GenFunction_1) func_80387E40, (intptr_t)this->marker);
                } else {
                    func_80326310(this);
                }
                if (this->actorTypeSpecificField < 5) {
                    ...
                    timedFunc_set_1(0.8f, (GenFunction_1)chCroctus_jiggySpawn, (intptr_t)this->marker);
                }
                __spawnQueue_add_2((GenFunction_2)func_80387D18, reinterpret_cast(intptr_t, this->marker), 0x46);
            }
        }
