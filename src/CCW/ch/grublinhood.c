...
void __chgrublinhood_die(ActorMarker* marker, s32 arg1) {
    ...
    __spawnQueue_add_4((GenFunction_4)spawnQueue_actor_f32, ACTOR_4C_STEAM, reinterpret_cast(intptr_t,actor->position_x), reinterpret_cast(intptr_t,actor->position_y), reinterpret_cast(intptr_t,actor->position_z));
