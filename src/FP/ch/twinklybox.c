...
void chTwinklyBox_completeMinigame(ActorMarker *marker){
    ...
    timedFunc_set_1(2.3f, (GenFunction_1)chTwinklyBox_destroyBox, (intptr_t)this->marker);
...
void chTwinklyBox_update(Actor *this){
    ...
    case 3: //L8038DA24, after hitting box
        ...
        if(actor_animationIsAt(this, 0.999f))
            __spawnQueue_add_1((GenFunction_1)chTwinklyBox_spawnTwinkly, (intptr_t)this->marker);
        ...
        __spawnQueue_add_1((GenFunction_1)chTwinklyBox_spawnSecondAndThirdMuncher, (intptr_t)this->marker);
    ...
    case 4: //L8038DB18, winning or losing minigame
        ...
        if(item_getCount(ITEM_24_TWINKLY_SCORE) == 0){
            ...
            timedFunc_set_1(1.3f, (GenFunction_1)chTwinklyBox_completeMinigame, (intptr_t)this->marker);
