...
void func_80387A2C(ActorMarker *caller, enum asset_e text_id, s32 arg2){
    ...
    timedFunc_set_1(0.5f, (GenFunction_1) func_80387984, reinterpret_cast(intptr_t, caller));
    ...
    timedFunc_set_1(6.0f, (GenFunction_1) GV_func_80387A00, reinterpret_cast(intptr_t, caller));
...
void chGobi2_setState(Actor *this, s32 next_state){
    ...
    if(next_state == 3){
        ...
        timedFunc_set_1(0.06f, (GenFunction_1)func_803879D4, reinterpret_cast(intptr_t, this->marker));
