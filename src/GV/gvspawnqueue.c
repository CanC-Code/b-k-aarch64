...
void func_8038F028(UNK_TYPE(s32) arg0, ActorMarker *arg1, s32 arg2, s32 arg3){
    ...
    if(mapSpecificFlags_get(arg2) == FALSE){
        ...
        __spawnQueue_add_4((GenFunction_4)spawnQueue_actor_f32, 0x4e, reinterpret_cast(intptr_t, sp24[0]), reinterpret_cast(intptr_t, sp24[1]), reinterpret_cast(intptr_t, sp24[2]));
