...
static void __chTreasure_die(ActorMarker *marker, ActorMarker *otherMarker){
    ...
    __spawnQueue_add_4((GenFunction_4) spawnQueue_actor_f32, 0x4C, reinterpret_cast(intptr_t, this->position[0]), reinterpret_cast(intptr_t, this->position[1]), reinterpret_cast(intptr_t, this->position[2]));
