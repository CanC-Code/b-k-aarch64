...
void chBeehive_die(ActorMarker *this, ActorMarker *other){
    ...
    actor->unk138_27 = 3;
    __spawnQueue_add_4((GenFunction_4)spawnQueue_actor_f32, ACTOR_4C_STEAM, reinterpret_cast(intptr_t, actor->position[0]), reinterpret_cast(intptr_t, actor->position[1]), reinterpret_cast(intptr_t, actor->position[2]));
    __spawnQueue_add_4((GenFunction_4)spawnQueue_actor_f32, ACTOR_4A_WOOD_EXPLOSION, reinterpret_cast(intptr_t, actor->position[0]), reinterpret_cast(intptr_t, actor->position[1]), reinterpret_cast(intptr_t, actor->position[2]));
