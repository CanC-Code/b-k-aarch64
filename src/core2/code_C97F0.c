...
void func_80350BFC(void) {
    ...
    __android_log_print(ANDROID_LOG_INFO, "BKA-CORE", "func_80350BFC: func_803507CC returned %p", (void*)D_80386170.unk4);
    if (D_80386170.unk4 != NULL) {
        LOG_BKA_INIT("calling func_80350780");
        D_80386170.unk0 = func_80350780(D_80386170.unk4->unk10);
        __android_log_print(ANDROID_LOG_INFO, "BKA-CORE", "func_80350BFC: func_80350780 returned %p", (void*)D_80386170.unk0);
        LOG_BKA_INIT("calling assetcache_get(0x882)");
        D_80386170.unk8 = assetcache_get(0x882);
        __android_log_print(ANDROID_LOG_INFO, "BKA-CORE", "func_80350BFC: assetcache_get returned %p", (void*)D_80386170.unk8);
